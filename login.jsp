...
<html>
    ...
    <body>
       ...
       <div class="col-sm-6">
           ...
           if(request.getParameter("mismatch")!=null){
            ...
            <%
                ...
                else if(request.getParameter("rsuccess")!=null){
       ...
       <div class="col-sm-12 panel panel-default" style=" padding:30px">
           ...
           <form action="cdemo.jsp" method="post">
               <label>Email id</label>
               <input type="text" name="email" placeholder="info@code4geeks.org" class="form-control" required=""/>
               <br/>
           ...
           <div class="col-sm-12 panel panel-default" style=" padding:15px">
               <center><h5>Don't have an account ?<a href="signup.jsp"> Sign up</a></h5></center>
           </div>
       </div>
